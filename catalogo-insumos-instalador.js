      ...
      <div class="eq-product-body">
        ...
        <div class="eq-product-price">
          ...
          <div class="eq-price-row">
            <strong>${(typeof INSTALADOR_PRICES !== "undefined" && INSTALADOR_PRICES[p.id] != null) ? formatPrice(INSTALADOR_PRICES[p.id]) : "Consultar precio"}</strong>
          </div>
...
function openProduct(id) {
  ...
  // Precio instalador simple, sin tachado/% OFF (insumos no tienen
  // precio de lista público contra el cual descontar).
  const __efectivo = (typeof INSTALADOR_PRICES !== "undefined") ? INSTALADOR_PRICES[p.id] : undefined;
  document.getElementById("modalPriceOriginal").textContent = "";
  document.getElementById("modalPrice").textContent = (__efectivo != null) ? formatPrice(__efectivo) : "Consultar precio";
