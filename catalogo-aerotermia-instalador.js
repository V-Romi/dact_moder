...
const FILTER_DEFS = [
  ...
  { key: "price", label: "Precio", options: ["Hasta $9.000.000", "Más de $9.000.000"] }
];

const filterState = { capacity: "", phaseType: "", price: "" };
...
function matchesPrice(value, price) {
  if (value === "Hasta $9.000.000") return price <= 9000000;
  if (value === "Más de $9.000.000") return price > 9000000;
  return true;
}
