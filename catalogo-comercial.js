...
const EQ_PRODUCTS = [
  ...
  },
  {
    ...
    capacityTR: 3.0,
    price: 2736030.96,
    priceOriginal: 4560051.6,
    installments: 6,
    installmentValue: 668807.57,
    isNew: false,
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 3581851.1,
    priceOriginal: 5969751.83,
    installments: 6,
    installmentValue: 875563.6,
    isNew: false,
    features: ["ON/OFF", "R410A"],
    technology: "ON/OFF",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 6.0,
    price: 3713532.26,
    priceOriginal: 6189220.44,
    installments: 6,
    installmentValue: 907752.33,
    isNew: false,
    features: ["ON/OFF", "R410A"],
    technology: "ON/OFF",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 3.0,
    price: 3394399.53,
    priceOriginal: 5657332.54,
    installments: 6,
    installmentValue: 829742.11,
    isNew: false,
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 4190928.8,
    priceOriginal: 6984881.33,
    installments: 6,
    installmentValue: 1024449.26,
    isNew: false,
    features: ["Inverter", "R32", "3 años", "Control remoto LCD"],
    technology: "Inverter",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 6.0,
    price: 4295534.7,
    priceOriginal: 7159224.5,
    installments: 6,
    installmentValue: 1050019.59,
    isNew: false,
    features: ["Inverter", "R32", "3 años", "Control remoto LCD"],
    technology: "Inverter",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 3.0,
    price: 2662904.61,
    priceOriginal: 4438174.35,
    installments: 6,
    installmentValue: 650932.24,
    isNew: false,
    features: ["ON/OFF", "R410A"],
    technology: "ON/OFF",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 3486740.56,
    priceOriginal: 5811234.27,
    installments: 6,
    installmentValue: 852314.36,
    isNew: false,
    features: ["ON/OFF", "R410A"],
    technology: "ON/OFF",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 6.0,
    price: 3612636.41,
    priceOriginal: 6021060.69,
    installments: 6,
    installmentValue: 883088.9,
    isNew: false,
    features: ["ON/OFF", "R410A"],
    technology: "ON/OFF",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 3.0,
    price: 3302297.35,
    priceOriginal: 5503828.92,
    installments: 6,
    installmentValue: 807228.24,
    isNew: false,
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 4075916.79,
    priceOriginal: 6793194.65,
    installments: 6,
    installmentValue: 996335.21,
    isNew: false,
    features: ["Inverter", "R32", "Control remoto LCD"],
    technology: "Inverter",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 6.0,
    price: 4178208.56,
    priceOriginal: 6963680.94,
    installments: 6,
    installmentValue: 1021339.87,
    isNew: false,
    features: ["Inverter", "R32", "Control remoto LCD"],
    technology: "Inverter",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 3850521.01,
    priceOriginal: 6417535.02,
    installments: 6,
    installmentValue: 941238.47,
    isNew: false,
    features: ["Inverter", "R32", "Control remoto LCD"],
    technology: "Inverter",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 6.0,
    price: 4112256.0,
    priceOriginal: 6853760.0,
    installments: 6,
    installmentValue: 1005218.13,
    isNew: false,
    features: ["Inverter", "R32", "Control remoto LCD"],
    technology: "Inverter",
    type: "Piso Techo",
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 4050461.41,
    priceOriginal: 6750769.02,
    installments: 6,
    installmentValue: 990112.79,
    isNew: false,
    features: ["ON/OFF"],
    technology: "ON/OFF",
    type: "Cassette",
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 3935912.23,
    priceOriginal: 6559853.71,
    installments: 6,
    installmentValue: 962111.88,
    isNew: false,
    features: ["ON/OFF"],
    technology: "ON/OFF",
    type: "Cassette",
  ...
  },
  {
    ...
    capacityTR: 5.0,
    price: 4773162.65,
    priceOriginal: 7955271.08,
    installments: 6,
    installmentValue: 1166773.09,
    isNew: false,
    features: ["Inverter", "R32", "Control remoto LCD"],
    technology: "Inverter",
    type: "Cassette",
  ...
  },
  {
    ...
    capacityTR: 6.0,
    price: 5351469.94,
    priceOriginal: 8919116.56,
    installments: 6,
    installmentValue: 1308137.1,
    isNew: false,
    features: ["Inverter", "R32", "Control remoto LCD"],
    technology: "Inverter",
    type: "Cassette",
...
function getPricing(p) {
  if (p.price == null) return { hasPrice: false };
  const discountPct = Math.round((1 - p.price / p.priceOriginal) * 100);
  return { hasPrice: true, original: p.priceOriginal, final: p.price, discountPct, installments: p.installments, installmentValue: p.installmentValue };
}
